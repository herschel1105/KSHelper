#
# Be sure to run `pod lib lint KSHelper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'KSHelper'
  s.version          = '0.1.0'
  s.summary          = 'A short description of KSHelper.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'KSHelper/Classes/**/*'
  
  # s.resource_bundles = {
  #   'KSHelper' => ['KSHelper/Assets/*.png']
  # }
